...
#define FIRST_LONGITUDINAL_GOAL_DISTANCE 0.11f
#define SECOND_LONGITUDINAL_GOAL_DISTANCE 0.41f
#define THIRD_LONGITUDINAL_GOAL_DISTANCE 0.71f
...
#define FIRST_LATERAL_GOAL_DISTANCE 0.11f
